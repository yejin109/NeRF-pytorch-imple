...
import numpy as np
from model_neus.embedder import get_embedder
...
def get_model(conf):
    ...
    log_internal('[Model] Model loaded')
    return nerf_outside, sdf_network, deviation_network, color_network, params_to_train
