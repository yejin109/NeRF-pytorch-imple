...
def get_render_kwargs(run_network, perturb, N_importance, model_fine, N_samples, model, add_3d_view, white_bkgd, raw_noise_std, no_ndc, lindisp, dataset):
    render_kwargs_train = {
